...
public class BasicScenarioAssignment4 {
	...
	static void modifyCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("modifycustomerclickoncustomernamelabel")).click();
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("reenteroncustomername")).sendKeys("demoUser");
			oBrowser.findElement(objectmap.getLocator("clickoncustomersettingsbutton")).click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
