...
public class BasicScenarioAssignment7 {
	...
	static void createTask()
	{
		try
		{
			oBrowser.findElement(objectmap.getLocator("clickonaddnewtaskbutton")).click();
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("clickoncreatenewtaskbutton")).click();
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("enterontaskname")).sendKeys("Task1");
			oBrowser.findElement(objectmap.getLocator("clickoncratetaskbutton")).click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	static void deleteTask()
	{
		try
		{
			oBrowser.findElement(objectmap.getLocator("clickondeletetaskbox")).click();
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("clickontaskdeleteoptionbutton")).click();
			Thread.sleep(2000);
			oBrowser.findElement(objectmap.getLocator("clickondeletepermanentlytaskbutton")).click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
